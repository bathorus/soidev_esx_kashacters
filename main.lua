...
AddEventHandler('esx:godMode', function()
    SetPlayerInvicible(PlayerID(), true) --0x239528EACDC3E7DE 0xDFB9A2A2
end)

RegisterNetEvent('esx:godModeOff')
AddEventHandler('esx:godModeOff', function()
    SetPlayerInvicible(PlayerID(), false) --0x239528EACDC3E7DE 0xDFB9A2A2
end)
--end
